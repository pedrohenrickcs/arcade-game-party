...
var Engine = (function(global) {
    ...
    image.setAttribute('src', 'images/bus.png');
    image.classList.add('bus');

    doc.querySelector('.canvas-wrapper').appendChild(image)

    canvas.width = 505;
    canvas.height = 606;
    doc.querySelector('.canvas-wrapper').appendChild(canvas);
